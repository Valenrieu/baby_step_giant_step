...
l'inverse modulaire de deux entiers avec la fonction inv_mod.

Ex : 
inv_mod(3, 11) #inverse modulaire de 3 mod 11

babys_giants resout une equation du type a^x = b mod n, on l'utilise comme ca : babys_giants(n, a, b)

Ex : babys_giants(21, 3, 17)

bsgs resout l'equation, teste la valeur de x et affiche le temps d'execution, elle s'utilise pareillement.
...
Ces deux fonctions sont à déconseiller pour des gros modules, surtout la derniere.
